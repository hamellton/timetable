  window.addEventListener('load', function() {
      ...
      function ClickHandler() {
          ...
          return function() {
              ...
              $('#campaign, #typeevent,  #theme, #additionaltheme, #additionalbook, #school, #time, #place, #managers, #comment, #driver, #type, #book, #numberc, #datesend, #advertcomment, #competitioncomment, #certificatecomment, #invitationcomment, #linkcomment, #reportcomment, #offercomment').val('');
      ...
      addevent.onsubmit = function() {
          ...
          var statusPlat = document.getElementsByName('statusP');
          ...
          for (var i = 0, length = statusPlat.length; i < length; i++) {
              if (statusPlat[i].checked) {
                  statusPlat = statusPlat[i].value;
                  break;
              }
          }
          ...
          xhr.onreadystatechange = function() {
              ...
              DataFromJSON.forEach(function(event, i, DataFromJSON) {
                  ...
                  buttonUpdate.addEventListener('click', function() {
                      ...
                      if (parent.classList[0] === 'platforma') {
                          document.getElementById('status-4').checked = true;
                      } else if (parent.classList[0] === 'event-1') {
                          document.getElementById('status-5').checked = true;
                      } else if (parent.classList[0] === 'event-2') {
                          document.getElementById('status-6').checked = true;
                      }
                  ...
                  if (eventPlat === 'zoom') {
                      wrapper.classList.add('platforma', 'event-view');
                  } else if (eventPlat === 'off-line') {
                      wrapper.classList.add('event-2', 'event-view');
                  } else if (eventPlat === 'clickmeeting') {
                      wrapper.classList.add('event-1', 'event-view');
                  }
