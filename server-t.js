            ...
            req
                ...
                .on('end', function() {
                    ...
                    chat.publish({
                        ...
                        eventTest: body.eventTest,
                        eventPlat: body.eventPlat,
                        radiob: body.radiob,
                        eventstatusb: body.eventstatusb,
                        date: body.date,
                        ...
                        eventoutline: body.eventoutline,
                        ...
                        if (obj.events.length === 0) {
                            ...
                            for (var y = 0; y < obj.events.length; y++) {
                                if (obj.events[y].id === sendBody.id) {
                                    ...
                                    obj.events[y].testEvent = sendBody.testEvent;
                                    obj.events[y].statusPlat = sendBody.statusPlat;
                                    obj.events[y].radiob = sendBody.radiob;
                                    obj.events[y].statusb = sendBody.statusb;
                                    ...
                                    obj.events[y].eventoutline = sendBody.eventoutline || '';
                                    obj.events[y].eventlink = sendBody.eventlink || '';
